...
class Prefs {
  ...
  static const String _newsMark = 'newsMark';
  static const String _newsMarkList = 'newsMarkList';
  ...
  static List<String> get newsMarkList => prefs?.getStringList(_newsMarkList)??[];
  static List<String> get newsMark => prefs?.getStringList(_newsMark)??[];
  ...
  static set newsMark(List<String> value) => prefs?.setStringList(_newsMark, value);

  static set newsMarkList(List<String> value) => prefs?.setStringList(_newsMarkList, value);
